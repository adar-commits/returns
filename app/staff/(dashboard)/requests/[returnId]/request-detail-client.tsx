    ...
    <>
      ...
      <header className={styles.detailHeader}>
        ...
        <div className={styles.actions}>
          <button type="button" className="btn btn-secondary" disabled={saving} onClick={() => patchHandling("in_progress")}>
            סמן בטיפול
          </button>
          <button type="button" className="btn btn-primary" disabled={saving} onClick={() => patchHandling("completed")}>
            סמן הושלם
          </button>
        </div>
      </header>
