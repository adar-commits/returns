 ...
 * Applied to both returned products (pickup) and new/replacement products (delivery).
 ...
 *   5.8 < x ≤ 8.16 → 150 ILS
 *   x > 8.16 → 300 ILS
 * Multiple products (all returned + new): highest fee + 50% of the sum of the other fees.
 */
